...
// en caso de que tenga un json
//import data from './data.json' y sustituir product.map por data.map
...
const seedProducts = () => {
    ...
    console.log("Productos subidos a la base de datos")
    return
}

seedProducts()

// Ejecutar el script con el comando: node ./src/seed/seedProducts.js desde el directorio raiz del proyecto
